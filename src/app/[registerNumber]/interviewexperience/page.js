    ...
    return (
        <>
            <div className="relative bg-gray-100 py-5 min-h-screen md:bg-gray-100">
                ...
                <div className="mx-auto mt-5 bg-white w-75 md:w-190 lg:w-250 rounded-xl shadow-xl p-2 border border-b-4 border-r-2 border-blue-900">
                    <div className="flex justify-center flex-row items-center gap-x-2">
                        <div className="select-none bg-blue-500 text-white font-sans font-bold text-2xl text-black rounded-3xl border-b-2 border-r-2 border p-2">
                            {username[0]}
                        </div>
                ...
                <div className="mx-auto w-75 md:w-190 lg:w-250 bg-gray-300 border-b-5 border-t-5 border-l-2 border-r-2 rounded-xl mt-5 h-140 overflow-hidden overflow-y-auto">
                    {
                        postData.map((post,index) => (
                            <div key={index}>
                                <div className="mx-auto bg-white w-72 md:w-170 lg:w-230 rounded-xl shadow-xl p-2 my-5 border border-t-5 border-b-5 border-r-3 border-l-3 border-blue-900">
                                    ...
                                    <div className="select-none my-2 rounded-xl shadow-xl shadow-gray-200 border p-2 mx-auto font-sans w-65 md:w-165 lg:w-190">
                                        {post.post}
                                    </div>
                                    <div className="flex flex-row">
                                        {
                                            !emoji[index] && 
                                                <div className="select-none lg:ml-15 text-2xl font-sans w-190">
                                        ...
                                        {
                                            emoji[index] && 
                                                <div className="flex flex-row jusify-between select-none lg:ml-17 rounded-xl shadow-2xl mt-2 w-50 text-2xl font-sans">
                                                    {
                                        ...
                                        {
                                            emojiClick[index] && (
                                                <div className="flex flex-row lg:mr-17 text-xl">
                                                    {emojiClick[index]}
                                                </div>
                                            )
                                        }
